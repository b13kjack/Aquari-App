  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <IoChatboxOutline
          size="23px"
          className={selected === "Forum" ? "text-yellow-200 group-hover:text-yellow-200 transition duration-200 ease-in-out" : "text-[#4e5467] group-hover:text-yellow-200 transition duration-200 ease-in-out"}
        />
      ),
    },
    {
